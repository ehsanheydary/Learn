                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="home-content text-center">
                                    <h1><?php
                                        ...
                                        $select = mysqli_query($conn,"SELECT * FROM title WHERE tId='1'");
        ...
        <section id="service" class="service sections">
            <div class="container">
                ...
                <div class="row">
                    <div class="wrapper">
                        <?php
                        $selectNews = mysqli_query($conn,"SELECT * FROM test LIMIT 4");
                        while ($rowNews = mysqli_fetch_assoc($selectNews)) {
